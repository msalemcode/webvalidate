...
namespace Smoker
{
    ...
    public class Test : IDisposable
    {
        ...
        public async Task<PerfLog> ExecuteRequest(Request r)
        {
            ...
            using HttpRequestMessage req = new HttpRequestMessage(new HttpMethod(r.Verb), MakeUrl(r.Url));
            ...
            PerfLog perfLog = GetPerfLog(r, res, duration, body);
            perfLog.StatusCode = (int)resp.StatusCode;
        ...
        public PerfLog GetPerfLog(Request r, string res, double duration, string body)
        {
        ...
        void LogToConsole(Request r, HttpResponseMessage resp, double duration, PerfLog perfLog, string res)
        {
        ...
        public async Task<bool> RunOnce()
        {
            ...
            // setup config
            _config = new Config { Verbose = true };
        ...
        public async Task<string> RunFromWebRequest()
        {
            ...
            List<Request> reqList = ReadJson("TestFiles/baseline.json");
